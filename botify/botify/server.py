...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            recommender = MyRecommender(tracks_redis.connection, recommendations_redis.connection, catalog)
        else:
        ...
        #     recommender = MyRecommender(tracks_redis.connection, my_recommendations_redis.connection, catalog)
        # else:
