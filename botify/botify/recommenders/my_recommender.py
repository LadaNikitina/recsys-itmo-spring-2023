...
class MyRecommender(Recommender):
    ...
    def __init__(self, tracks_redis, recommendations_redis, catalog):
        ...
        self.user_embs = np.load('/app/botify/recommenders/user_embeddings.npy')
        self.context_embs = np.load('/app/botify/recommenders/context_embeddings.npy')
        self.track_embs = np.load('/app/botify/recommenders/track_embeddings.npy')
